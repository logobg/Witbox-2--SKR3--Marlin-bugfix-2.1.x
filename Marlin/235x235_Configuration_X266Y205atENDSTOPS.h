...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 25.4272
    #define DEFAULT_Ki 2.4272
    #define DEFAULT_Kd 66.5939
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
    #define DEFAULT_bedKp 335.3941
    #define DEFAULT_bedKi 65.5259
    #define DEFAULT_bedKd 1144.4766
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 99.6048 }
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS (X_BED_SIZE + 34)
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (X_BED_SIZE - 38)  // X point for Z homing
