...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 25.1796
    #define DEFAULT_Ki 2.4402
    #define DEFAULT_Kd 64.9539
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
    #define DEFAULT_bedKp 253.1825
    #define DEFAULT_bedKi 48.6983
    #define DEFAULT_bedKd 877.5305
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 100.99931 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 34, 0, -1.8 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 4  // X point for Z homing
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS              1000 // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)
